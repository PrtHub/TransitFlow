  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center lg:items-start justify-center lg:justify-start gap-5 ">
       <div className="w-full h-full sm:w-[453px] sm:h-[308px] relative">
         ...
         { show && 
          <div className="w-[323px] h-[203px] m-auto bg-[#1C1F35] bg-opacity-90 z-10 absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center text-white font-Krub cursor-pointer">Read More</div>
         }
       </div>
       <div className="flex justify-start items-start gap-4">
           <div className="flex flex-col justify-center items-center gap-2">
               ...
               <div className="flex flex-col items-center justify-center gap-0">
                <p className="text-[#1C1F35] text-3xl md:text-4xl lg:text-5xl font-Rubik font-semibold">{date}</p>
                <p className="text-[#666C89] text-sm font-Krub">September</p>
               </div>
           </div>
           <div className="max-w-[335px] h-full flex flex-col justify-start items-start gap-2">
               ...
               <p className="font-Krub font-medium text-[#666C89] text-sm">We are dedicated in creating added value for our customers by implementing modern technology in our work. </p>
               <ul className="flex flex-col items-start gap-1 p-4 list-disc font-Krub text-[#1C1F35] text-sm">
