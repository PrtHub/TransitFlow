      ...
      <div className="w-full h-full bg-white">
        <div className="w-full xl:w-[1200px] h-full mx-auto flex flex-col items-start justify-between gap-10 sm:gap-14 py-20 px-7 xl:px-0">
          <section className="flex flex-col items-start justify-start gap-2 font-Rubik ">
            <p className="head-text">Testimonial</p>
            <h1 className="header-text">What Our Customer Say</h1>
          </section>

          <section className="w-full h-full flex flex-col lg:flex-row  items-center justify-center gap-10">
            <div className="w-full sm:w-[600px] h-full flex flex-col items-start justify-start gap-4 bg-[#F4F4F4] p-6 sm:p-10">
              ...
              <section className="w-full h-full font-Krub text-xs sm:text-base">
