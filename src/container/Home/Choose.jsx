  ...
  return (
    <>
      <div className="w-full h-full bg-[#F4F4F4] flex lg:flex-row flex-col items-center justify-start gap-20">
        <section className="h-full md:w-[800px]">
          <img src={plane} alt="" className="w-full h-full object-contain" />
        </section>

        <section className="w-full max-w-[500px] h-full flex flex-col items-start justify-start gap-3 font-Rubik sm:px-0 px-8 ">
          <p className="head-text">Why Choose</p>
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <p className="icon-text">Delivery on Time</p>
            </div>
            <div className="flex items-center justify-start gap-2 mt-2">
              <RiShipLine className="icon" />
              <p className="icon-text">Ship Everyware</p>
            </div>
            <div className="flex items-center justify-start gap-2 mt-2">
              <AiOutlineGlobal className="icon" />
              <p className="icon-text">Global Tracking</p>
            </div>
            <div className="flex items-center justify-start gap-2 mt-2">
            ...
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <p className="icon-text">In Time Delivery</p>
            </div>
            <div className="flex items-center justify-start gap-2 mt-2">
              <ImPriceTags className="icon" />
              <p className="icon-text">Transparant Pricing</p>
            </div>
          </div>
        </section>
      </div>
